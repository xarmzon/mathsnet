...
const Navbar = ({ navState }) => {
  ...
  return (
    <div
      ...
      } left-0 transition-all duration-500  pt-6 bg-primary pb-10 md:pb-0 md:relative md:pt-0 md:w-auto`}
    >
      <div className="flex flex-col items-center space-y-5 md:flex-row md:space-x-4 relative">
        <FaTimes

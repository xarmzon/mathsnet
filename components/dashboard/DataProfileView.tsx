              ...
              <div className="flex flex-col w-full">
                ...
                {!showEdit && (
                  <div className="flex flex-col w-full">
                    ...
                    <div
                      className={`w-full ${
                        user.aboutMe && "divide-y divide-gray-600"
                      } space-y-4`}
                    >
                      <p className="text-center tex-sm text-gray-400 italic">
                        Joined since {dateformat(user.createdAt, "mediumDate")}
                      </p>
                      {user.aboutMe && (
                      ...
                      <div className="flex flex-col">
                        <QuillEditor
                          ...
                          onChange={(v) =>
                            setFormData((prev) => ({
                              ...prev,
                              aboutMe: { value: v, error: "" },
                            }))
                          }
                          theme="profile"
                        />
                        <MessageBox
                          msg={formData.aboutMe.error}
                          type="error"
                          show={
                            formData.aboutMe.error.length > 0 ? true : false
                          }
                        />
                      </div>
                    )}
